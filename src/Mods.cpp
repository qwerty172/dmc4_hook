...
#include "mods/PiercingShots.hpp"
#include "mods/HoneycombKnockback.hpp"
#include "mods/NeroComboBBuff.hpp"
#include "mods/NeroDiagonalAirHike.hpp"
...
Mods::Mods() {
    ...
    ADD_MOD(PiercingShots);
    ADD_MOD(HoneycombKnockback);
    ADD_MOD(NeroComboBBuff);
    ADD_MOD(NeroDiagonalAirHike);
